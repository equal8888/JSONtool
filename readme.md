# Rest-Client... I guess 🤔
<br>
this website based tool is making the life easier by removing the task of installing plugins, and because of nested json objects can be sometimes difficult to read, the task is made easier on the GUI side.
<br>
<br>
