   ...
   xobj.onreadystatechange = function () {
         if (xobj.readyState == 4 && xobj.status == "200") {
           if (`${url}`=='Gjson01') {
             ...
             appendData(atob(xobj.responseText),'index01');
             clearBox2('json01')
             console.log('json01');

           } else if (`${url}`=='jp02') {
             appendData(atob(xobj.responseText),'json01');
             clearBox1('index01')
             console.log('index01');
...
function clearBox1()
{
    document.getElementById('index01').innerHTML = "";
}
function clearBox2()
{
    document.getElementById('json01').innerHTML = "";
}
function clearBox3()
{
